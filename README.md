...
<img src="/unemployment.png" alt="Unemployment Analysis" width="600" height="600" />
...
1. Region: The state or region where unemployment data is recorded.
2. Date: The month/year the data was collected.
3. Frequency: The frequency of data collection (e.g., Monthly, Quarterly).
